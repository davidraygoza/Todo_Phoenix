defmodule FullstackElixirReact.TodosTest do
  use FullstackElixirReact.DataCase

  alias FullstackElixirReact.Todos

  describe "items" do
    alias FullstackElixirReact.Todos.Item

    @valid_attrs %{completed_at: "2010-04-17T14:00:00Z", conten: "some conten"}
    @update_attrs %{completed_at: "2011-05-18T15:01:01Z", conten: "some updated conten"}
    @invalid_attrs %{completed_at: nil, conten: nil}
    ...
    test "create_item/1 with valid data creates a item" do
      ...
      assert item.conten == "some conten"
    end
    ...
    test "update_item/2 with valid data updates the item" do
      ...
      assert item.conten == "some updated conten"
    end
